...
class DownloadNotification {
	...
	public class NotificationItem {
		public int mId; // This first db _id for the download for the app
		public long mTotalCurrent = 0;
		public long mTotalTotal = 0;
		public int mTitleCount = 0;
		public String mPackageName; // App package name
		public String mDescription;
		public String[] mTitles = new String[2]; // download titles.
	...
	private void updateActiveNotification(Collection<DownloadInfo> downloads) {
		...
		for (DownloadInfo download : downloads) {
			...
			if (mNotifications.containsKey(title)) {
				//
				item = mNotifications.get(title);
