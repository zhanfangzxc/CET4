...
public class DownloadInfo {
	...
	public static class Reader {
		...
		public void updateFromDatabase(DownloadInfo info) {
			...
			info.mBypassRecommendedSizeLimit = getInt(Downloads.COLUMN_BYPASS_RECOMMENDED_SIZE_LIMIT);
		...
		private void readRequestHeaders(DownloadInfo info) {
			...
			try {
				int headerIndex = cursor
						.getColumnIndexOrThrow(Downloads.RequestHeaders.COLUMN_HEADER);
				int valueIndex = cursor
						.getColumnIndexOrThrow(Downloads.RequestHeaders.COLUMN_VALUE);
